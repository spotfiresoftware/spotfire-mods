...
![Gantt chart example](GanttChartModExample.png)
...
- The current state of the zoom slider, vertical scroll bar or the view-mode slider cannot be transferred to the export visualization.
- Due to performance issues, the data view is limited to 200 rows.
