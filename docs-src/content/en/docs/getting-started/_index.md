...
This example is a basic bar chart that is built using the Google Charts library. The [tutorial](http://dashboard:5000/tutorials/barchart-googlechart/README.md) covers the steps taken to create this bar chart from scratch.
