...
/**
 * Color information for a row when a color axis is defined in the manifest.
 * @public
 */
...
export declare interface DataViewRow {
    ...
    /**
     * Gets the {@link DataViewColorInfo} for the row, if a color axis is defined in the manifest.
     * Use {@link DataViewRow.categorical}("Color") or {@link DataViewRow.continuous}("Color") to retrieve the underlying data value.
     */
